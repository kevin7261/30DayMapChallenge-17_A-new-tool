      ...
      const addNuclearPlants = () => {
        ...
        const plants = [
          // 核電廠陣列
          {
            ...
            fullName: '核一廠（已除役）',
            status: '已除役',
            lon: 121.58645374071105,
            lat: 25.28217918564773,
          }, // 核一廠
          {
            name: '核二廠',
            fullName: '核二廠（已除役）',
            status: '已除役',
            lon: 121.66007007126909,
            lat: 25.20656016057692,
          }, // 核二廠
          {
            name: '核三廠',
            fullName: '核三廠',
            status: '運轉中',
            lon: 120.75248580566166,
            lat: 21.958800674458555,
          }, // 核三廠
          {
            name: '核四廠',
            fullName: '核四廠（封存中）',
            status: '封存中',
            lon: 121.9260466153821,
            lat: 25.039367726184043,
          }, // 核四廠
        ]; // plants 陣列結束
